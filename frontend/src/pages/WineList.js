...
const CATEGORIES = ['', 'white', 'red', 'rose', 'sparkling', 'dessert', 'avec']
const CAT_LABELS  = { '': 'Alle', white: 'Hvidvin', red: 'Rødvin', rose: 'Rosé', sparkling: 'Mousserende', dessert: 'Dessertvin', avec: 'Avec' }
              ...
              {wines.map(w => {
                ...
                return (
                  <tr key={w.id}>
                    ...
                    <td style={{ color: 'var(--text-muted)', fontSize: '0.82rem' }}>{w.vintage}</td>
