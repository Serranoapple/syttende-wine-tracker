...
const CATEGORIES = ['', 'white', 'red', 'rose', 'sparkling', 'still_champagne', 'fortified', 'dessert', 'avec', 'beer', 'non_alcoholic']
const CAT_LABELS  = { '': 'Alle', white: 'Hvidvin', red: 'Rødvin', rose: 'Rosé', sparkling: 'Mousserende', still_champagne: 'Coteaux Champ.', fortified: 'Hedvin', dessert: 'Dessertvin', avec: 'Avec', beer: 'Øl', non_alcoholic: 'Alkoholfri' }
const CAT_BADGE   = { white: 'badge-white', red: 'badge-red', rose: 'badge-rose', sparkling: 'badge-sparkling', still_champagne: 'badge-sparkling', fortified: 'badge-dessert', dessert: 'badge-dessert', non_alcoholic: 'badge-white', beer: 'badge-white', avec: 'badge-white' }
