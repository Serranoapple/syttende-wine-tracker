...
CATEGORY_KEYWORDS = {
    # Multi-word and most specific matches first
    "WHITE WINE": "white",
    "RED WINE": "red",
    ...
    "RØDVIN": "red",
    # Dessert/sweet — must come before single-word ROSÉ/SPARKLING
    "SØDT": "dessert",          # "BOBLER & SØDT" PDF has a SØDT section
    "DESSERTVIN": "dessert",
    "ALKOHOLFRI": "non_alcoholic",
